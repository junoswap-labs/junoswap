    ...
    return (
        <section className="py-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="relative overflow-hidden rounded-3xl bg-card border border-border/50 px-6 py-20 sm:px-12 sm:py-24 lg:px-16 transition-all duration-500 shadow-[0_0_60px_-15px_hsl(0_100%_60%_/_0.15)]">
